...
public class Log {
    ...
    class func d<T>(_ object: T?, filename: String = #file, line: Int = #line, funcname: String = #function) {
        ...
        Log.customLog(object as! [Any?], filename: filename, line: line, funcname: funcname)
...
//        print("‣ \(filename.components(separatedBy: "/").last ?? "") | Line: \(line) | \(funcname.replace(":", with: ", ").replace(of: ", )", with: ")"))")
